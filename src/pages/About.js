...
const About = () => {
  return (
    <div className='m-8 mt-0 bg-gradient-to-r from-green-400 to-blue-500 text-neutral-100'>
      <h1 className='pt-8 text-4xl text-amber-300 text-center font-semibold'>What Makes Us Unique in the IT World!</h1>
