...
const Home = ({ loggedInUser }) => {
  return (
    <div className='m-8 mt-0 bg-gradient-to-r from-amber-500 to-red-500 text-neutral-100 min-h-[80vh]'>
      {loggedInUser ? (
        <>
          ...
          <div className='flex items-center justify-center'>
            <img className='p-8 w-2/3 object-cover rounded-lg border-2 border-amber-400' src={BannerImg} alt="Hero" />
          </div>
        </>
      ) : (
